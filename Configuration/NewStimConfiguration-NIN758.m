...
pixels_per_cm = 1980/50; % Alexander's desktop 2025-02-21

NewStimViewingDistance = 50; %cm, 
...
%LoadGammaCorrectionTable('testclut_gamma_4.txt');
%LoadGammaCorrectionTable('testclut_green.txt');
%LoadGammaCorrectionTable('gct_nin657.txt');
...
StimSerialScriptIn = 'COM5';       % NewStim flips ScriptOutPin on this port when trial starts
StimSerialScriptInPin = 'dtr';       % flips this pin when trial starts
StimSerialScriptOut = 'COM5';     % same
StimSerialScriptOutPin = 'dtr';       %
StimSerialStimIn = 'COM5';  % NewStim flips DTR on this this port when individual stimuli start
StimSerialStimInPin = 'rts';  % NewStim flips this pin when individual stimuli start
StimSerialStimOut = 'COM5';% same
StimSerialStimOutPin = 'rts';% same
